...
class AppForm(QMainWindow):
    ...
    def init_draw(self):
        ...
        self.points = []
        self.axes.plot(3., 2., 'y*', ms=10)
        self.axes.plot(-2.805118, 3.131312, 'y*', ms=10)
        self.axes.plot(-3.779310, -3.283186, 'y*', ms=10)
        self.axes.plot(3.584428, -1.848126, 'y*', ms=10)
...
if __name__ == '__main__':
    ...
    main(log_path=log_path, func=function.himmelblau)
